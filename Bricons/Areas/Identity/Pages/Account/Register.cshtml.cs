...
namespace Bricons.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
       ...
       // private readonly IEmailSender _emailSender;
        ...
        public class InputModel
        {
            ...
            [Range(10000000, 99999999, ErrorMessage = "Dni no valido")]
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Contraseña: 6-100 caracteres", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                user.Usuario = new Models.Usuario()
                {
                    Nombre = Input.Nombre,
                ...
                if (result.Succeeded)
                {
                    ...
                    //Crear los roles si no existieran
                    ...
                    //Obtener el rol seleccionado en el formulario de registro
                    string rol = Request.Form["radUserRole"].ToString();
